...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($salaryMinRaw !== '') {
        $salaryMin = (float) str_replace(',', '', $salaryMinRaw);
    }

    if ($salaryMaxRaw !== '') {
        $salaryMax = (float) str_replace(',', '', $salaryMaxRaw);
    }

    if ($currencyInput !== '') {
        $currency = strtoupper(preg_replace('/[^A-Z]/', '', $currencyInput));
        ...
        <div class="cp-form-card">
            ...
            <form id="createPostForm" method="POST" action="" novalidate>
                ...
                <div class="cp-section">
                    ...
                    <div class="cp-row">
                        <div class="cp-field">
                            <label class="cp-label" for="salaryMin">Salary Min</label>
                            <input type="number" class="cp-input" id="salaryMin"
                                   name="salaryMin"
                                   min="0" step="0.01">
                        </div>
                        <div class="cp-field">
                            <label class="cp-label" for="salaryMax">Salary Max</label>
                            <input type="number" class="cp-input" id="salaryMax"
                                   name="salaryMax"
                                   min="0" step="0.01">
                        </div>
                        <div class="cp-field">
                            <label class="cp-label" for="salaryCurrency">Currency</label>
                            <input type="text" class="cp-input" id="salaryCurrency"
                                   name="salaryCurrency"
                                   placeholder="TND" maxlength="3">
                        </div>
                    </div>
                </div>
